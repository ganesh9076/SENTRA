...
// // window.updateNodeStatus = function(lbl, newStatus) {
...
// //   // Update any "X Nodes Online" badge in the header
...
// //         <div class="stat">
// //           <div class="stat-val">${n.peers}</div>
// //           <div class="stat-lbl">Peers</div>
// //         </div>
// //         <div class="stat">
// //           <div class="stat-val">${n.msgs}</div>
// //           <div class="stat-lbl">Msgs</div>
// //         </div>
// //         <div class="stat">
// //           <div class="stat-val">${n.ioc}</div>
// //           <div class="stat-lbl">IOCs</div>
// //         </div>
// //       </div>
// //     </div>`;
// //   }).join('');
...
// // /* ══════════════════════════════════════════════════════════════════
// //    DOWNLOAD ALL NODES
// //    Exports node data as JSON, CSV, or both (user-triggered)
// //    ══════════════════════════════════════════════════════════════════ */
...
// //       n.ip,
// //       n.port,
// //       n.status === 'clean' ? 'online' : n.status,
// //       n.peers,
// //       n.msgs,
// //       n.ioc,
// //       n.score,
...
//     // Stale infected/immune states must never persist when idle.
//     if (!data.running) {
//       resetAllNodeStates();
//       return;
//     }

//     // Only apply backend state when simulation is actively running
//     data.nodes.forEach(bn => {
//       const targetId = toNodeId(bn.lbl);
//       const node = nodes.find(n => n.id === targetId);
//       if (node) {
...
//   // FIX: If this is the very first node, reset backend gossip state
//   // so stale infected/immune data from previous simulations cannot
//   // leak into this fresh session.
//   if (nodes.length === 0) {
//     try {
...
//       }
//     } catch(e) {
//       console.warn('[NodeManager] Could not reset gossip state:', e);
//     }
//   }
